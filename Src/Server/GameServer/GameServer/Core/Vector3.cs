...
namespace GameServer.Core
{
    public partial struct Vector3 : IEquatable<Vector3>, IFormattable
    {
        ...
        public static float Rad2Deg { get { return 360f / ((float)Math.PI * 2f); } }
        ...
        public static float AngleBetween(Vector3 from, Vector3 to) { return (float)Math.Acos(Clamp(Vector3.Dot(from.normalized, to.normalized), -1F, 1F)); }
